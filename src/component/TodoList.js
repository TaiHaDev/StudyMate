...
const TodoList = ({ onRemoveHandler }) => {
  ...
  return (
    <div className="w-96 h-80 bg-slate-200 rounded-lg px-4 py-2 resize-y overflow-auto absolute right-5 top-72">
      ...
      {tasks.map((task, index) => (
        ...
        <div className="flex items-center justify-between my-3" key={task.id}>
